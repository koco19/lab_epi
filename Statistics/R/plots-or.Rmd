...
here_output = function (...) here::here("Statistics", "Output", ...)
...
d.orig <- read_xlsx(here_output("OR_Multiple Regression_Final.xlsx"),
                    skip=1, sheet = 1)
d.orig
freq <- d.orig[,1:5]
...
#################################################################
# Load data OR Roche
d.orig <- read.csv(here_output("Odds Ratio _Roche1a.csv"), 
                   sep=";", header=TRUE)
str(d.orig)
