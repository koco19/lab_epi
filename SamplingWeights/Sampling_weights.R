...
# Missing values for IgG/IgA -> removed (1)
# KoCo_BLab <- KoCo_BLab[!(is.na(KoCo_BLab$R_Result) | is.na(KoCo_BLab$IgG_result) |
#                            is.na(KoCo_BLab$IgA_result)), ]
...
load(here_data("contiguity_matrices-munich-constituencies_200914.RData"))
...
# Creating a variable with the number of people (ppl) in the households that are in the study population
...
# Calculating the weight for ppl in the household depending on other mm of the hh (not taking part in the study)
KoCo_BLab$w_ind <- KoCo_BLab$obs_hh_members / KoCo_BLab$n_ppl_part_hh 
