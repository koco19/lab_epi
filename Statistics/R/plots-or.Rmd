...
d.orig <- read_xlsx("Odds Ratio _Multivariate Analysis Roche_oct5.xlsx",
                    skip=1, sheet = 2)
d.orig
freq <- d.orig[,1:6]
bayes <- d.orig[,c(1:2, 8:11)]

names(d.orig)
names(freq) <- c("Variable", "Value", "estimate", "low", "high", "pval")
...
ggsave("Epi-Fig5-Model-Multivariate-201020.pdf", width=7, height=3)
ggsave("Epi-Fig5-Model-Multivariate-201020.png", width=7, height=3)


# Load data OR Roche
d.orig <- read.csv("Odds Ratio _Roche1a.csv", sep=";",
                   header=TRUE)
str(d.orig)
...
ggsave("Epi-Fig4-Model-OR-Roche1a-overlap-201021.pdf", width = 10, height=12)
ggsave("Epi-Fig4-Model-OR-Roche1a-overlap-201021.png", width = 10, height=12)
