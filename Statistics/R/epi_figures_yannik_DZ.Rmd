...
ggsave(here_out("DZ_prevalence.pdf"), width=2.5, height=3.5, dpi=720)
```
...
ggsave(here_out("DZ_fig1.pdf"), width=10, height=5, dpi=720)
```
...
ggsave(here_out("DZ_fig2.pdf"), width=10, height=3, dpi=720)
```
